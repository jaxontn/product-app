        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                ...
                <a class="dropdown-item pb-2 mb-1" >
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <small class="text-muted">dept: Software</small>
                      <br><small class="text-muted">role  : {{ auth()->user()->therole->name }}</small>
                    </div>
                  </div>
                </a>
              </li>
              ...
              {{--<li>
                <a class="dropdown-item" href="/account-settings-account">
              ...
              <li>
                <a id="logout-link" class="dropdown-item" href="javascript:void(0);">
                  <span class="d-flex align-items-center align-middle">
                    <i class="flex-shrink-0 mdi mdi-power me-1 mdi-20px"></i>
                    <span class="flex-grow-1 align-middle ms-1">Log Out</span>
                  </span>
                </a>
